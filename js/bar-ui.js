(function(window) {
  ...
  Player = function(playerNode) {
    ...
    function setTitle(item) {
      ...
      dom.playlistTarget.innerHTML = '<ul class="sm2-playlist-bd"><li id="currentTitle">' + item.innerHTML.replace(extras.loadFailedCharacter, '') + '</li></ul>';
    ...
    function makeSound(url) {
      ...
      var sound = soundManager.createSound({
        ...
        onfinish: function() {
          ...
          //Appel main.js lors de la fin d'une musique
          changeMusicProcess();
...
//procedure d'enregistrement de lecture
function changeMusicProcess() {
  app.changeMusic();
};
